...
// a randomly selected element as its return value.
    ...
    const partnerNames = ['Ali', 'Pooya', 'Nariman', 'Jack', 'Thomas'];
    const locations = ['Iran', 'Gemany', 'Britain', 'Turkey', 'Canada'];
    const jobTitles = ['Web Developer', 'Informatiker', 'editor', 'teacher', 'Translator'];
...
function selectRandomly(array) {
    const ran = array[Math.floor(Math.random() * 4)]
    return ran
